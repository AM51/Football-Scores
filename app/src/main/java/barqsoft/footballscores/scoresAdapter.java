...
public class scoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.score.setContentDescription("Match Score :: "+Utilies.getScores(cursor.getInt(COL_HOME_GOALS),cursor.getInt(COL_AWAY_GOALS)));
        ...
        //Log.v("archit",cursor.getString(COL_HOME)+" "+cursor.getString(COL_HOME_GOALS));
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            share_button.setContentDescription(context.getString(R.string.share));
